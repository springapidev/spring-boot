...
--
-- Create schema scheduleex
--

CREATE DATABASE IF NOT EXISTS scheduleex;
USE scheduleex;
...
--
-- Dumping data for table `src_test`
--

/*!40000 ALTER TABLE `src_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `src_test` ENABLE KEYS */;
